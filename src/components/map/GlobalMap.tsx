...
import { MOCK_SPOTS, MOCK_REGIONS, MOCK_COUNTRIES, MOCK_TRIPS } from "@/data/mockData";
...
export function GlobalMap() {
  ...
  const spinEnabled = !activeSpotId && !selectedRegionId && !selectedCountryId && !selectedTripId;
  ...
  }, [viewMode, selectedCountryId, selectedRegionId, activeSpotId, selectedTripId, selectedTrip]);
    ...
    <div className="w-full h-full bg-black">
      <Map
        ...
        onClick={(e) => {
           if (e.features && e.features.length > 0) {
               ...
               if (feature.layer?.id === 'spots-hit-layer' || feature.layer?.id === 'spots-layer') {
      ...
      >
        ...
        <Source id="local-spots" type="geojson" data={spotsGeoJSON as any}>
                ...
                filter={[
                   'any',
                    ...
                    ['all', 
                        ...
                        ['in', ['get', 'id'], ['literal', selectedTrip ? selectedTrip.spots : []]]
                    ],
            ...
            />
             <Layer
                ...
                filter={[
                   'any',
                    ['all', ['==', ['literal', viewMode], 'trip'], ['in', ['get', 'id'], ['literal', selectedTrip ? selectedTrip.spots : []]]],
                    ['all', ['==', ['literal', viewMode], 'region'], ['==', ['get', 'regionId'], selectedRegionId || '']]
                ]}
             />
             <Layer
        ...
        {viewMode === 'region' && (
          <>
            {/* Level 0: Countries */}
            {!selectedCountryId && Object.values(MOCK_COUNTRIES).map(country => (
              <Marker
                key={country.id}
            ...
            {/* Level 1: Regions */}
            {selectedCountryId && !selectedRegionId && Object.values(MOCK_REGIONS)
              .filter(r => {
                 const country = MOCK_COUNTRIES[selectedCountryId];
        ...
        {viewMode === 'trip' && selectedTrip && tripLineGeoJSON && (
            <Source id="trip-line" type="geojson" data={tripLineGeoJSON as GeoJSON.Feature<GeoJSON.LineString>}>
              <Layer 
                id="trip-line-layer"
                type="line"
                paint={{
